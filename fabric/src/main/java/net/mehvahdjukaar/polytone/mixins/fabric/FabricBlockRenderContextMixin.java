...
public class FabricBlockRenderContextMixin {
    ...
    private Vec3 polytone$modifyVisualOffset(BlockState instance, BlockGetter blockGetter, BlockPos pos, Operation<Vec3> original) {
        Vec3 m = Polytone.BLOCK_MODIFIERS.maybeModifyOffset(instance,blockGetter, pos);
        if (m != null) {
            return m;
        }
