...
public abstract class CurioInventoryScreenMixin {
    ...
    @ModifyArg(method = "renderBg", at = @At(value = "INVOKE",
            colormapToFill = "Lnet/minecraft/client/gui/screens/inventory/InventoryScreen;renderEntityInInventoryFollowsMouse(Lnet/minecraft/client/gui/GuiGraphicsExtractor;IIIIIFFFLnet/minecraft/world/entity/LivingEntity;)V")
            , index = 1
    )
