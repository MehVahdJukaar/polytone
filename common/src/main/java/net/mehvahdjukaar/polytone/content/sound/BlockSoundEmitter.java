...
public record BlockSoundEmitter(
    ...
    public static final SchemaCodec<BlockSoundEmitter> CODEC = SchemaRecord.create(BlockSoundEmitter.class, i -> i.group(
            ...
            i.optional("z", IBlockExp.CODEC_LEGACY, IBlockExp.ZERO, BlockSoundEmitter::z),
            i.optional("volume", IBlockExp.CODEC_LEGACY, IBlockExp.ZERO, BlockSoundEmitter::volume),
            i.optional("pitch", IBlockExp.CODEC_LEGACY, IBlockExp.ZERO, BlockSoundEmitter::pitch),
