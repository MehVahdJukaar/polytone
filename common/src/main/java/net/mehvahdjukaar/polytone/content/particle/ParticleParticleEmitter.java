...
public record ParticleParticleEmitter(
    ...
    public static final SchemaCodec<ParticleParticleEmitter> CODEC = SchemaRecord.create(ParticleParticleEmitter.class, i -> i.group(
            ...
            i.optional("chance", IParticleExp.CODEC_LEGACY, IParticleExp.ONE, ParticleParticleEmitter::chance),
            i.optional("count", IParticleExp.CODEC_LEGACY, IParticleExp.ONE, ParticleParticleEmitter::count),
            i.optional("x", IParticleExp.CODEC_LEGACY, IParticleExp.PARTICLE_RAND, ParticleParticleEmitter::x),
            i.optional("y", IParticleExp.CODEC_LEGACY, IParticleExp.PARTICLE_RAND, ParticleParticleEmitter::y),
            i.optional("z", IParticleExp.CODEC_LEGACY, IParticleExp.PARTICLE_RAND, ParticleParticleEmitter::z),
            i.optional("dx", IParticleExp.CODEC_LEGACY, IParticleExp.ZERO, ParticleParticleEmitter::dx),
            i.optional("dy", IParticleExp.CODEC_LEGACY, IParticleExp.ZERO, ParticleParticleEmitter::dy),
            i.optional("dz", IParticleExp.CODEC_LEGACY, IParticleExp.ZERO, ParticleParticleEmitter::dz),
            i.optional("red", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::r),
            i.optional("green", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::g),
            i.optional("blue", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::b),
            i.optional("alpha", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::a),
            i.optional("roll", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::roll),
            i.optional("size", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::size),
            i.optional("custom", IParticleExp.CODEC_LEGACY, ParticleParticleEmitter::custom),
            i.optional("customs", Codec.unboundedMap(Codec.STRING, IParticleExp.CODEC_LEGACY), Map.of(),
