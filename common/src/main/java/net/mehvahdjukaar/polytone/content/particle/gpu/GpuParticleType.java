...
public record GpuParticleType(ResourceLocation texture,
    ...
    public static final SchemaCodec<GpuParticleType> CODEC = SchemaRecord.create(GpuParticleType.class, i -> i.group(
            i.field("texture", ResourceLocation.CODEC, GpuParticleType::texture),
            i.optional("shader", ResourceLocation.CODEC, DEFAULT_SHADER, GpuParticleType::shader),
            i.optional("limit", Codec.intRange(1, MAX_LIMIT), 16384, GpuParticleType::limit),
            i.optional("force_spawn", Codec.BOOL, false, GpuParticleType::forceSpawn),
            ...
            i.optional("color_end", ColorUtils.CODEC, GpuParticleType::colorEnd),
