...
public class CustomItemModelsManager extends JsonPartialReloader {
    ...
    protected void earlyProcess(ResourceManager resourceManager) {
        ...
        for (var e : jsons.entrySet()) {
            ...
            /*
            var partial = Parsed.parseOrNull(StandaloneItemModelOverride.CODEC_MODEL_ONLY, json, JsonOps.INSTANCE, id, "custom item model");
            if (partial != null && !partial.autoModel()) {
    ...
    protected void parseWithLevel(Map<ResourceLocation, JsonElement> jsons, RegistryOps<JsonElement> ops, HolderLookup.Provider access) {
        ...
        for (var v : jsons.entrySet()) {
            ...
            /*
            var modelOverride = Parsed.parseOrNull(StandaloneItemModelOverride.CODEC, json, ops, location, "custom item model");
