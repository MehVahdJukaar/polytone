...
public class ParticleProxy extends PositionalProxy {
    ...
    public double roll() {
        // On 1.21.1, roll is on Particle (not SingleQuadParticle)
        return particle.roll;
    }
    ...
    public double custom() {
        // Stub - CustomParticleInstance not present on 1.21.1
        return 0;
    }
    ...
    public void roll(double roll) {
        // On 1.21.1, roll is on Particle
        particle.roll = (float) roll;
    }
