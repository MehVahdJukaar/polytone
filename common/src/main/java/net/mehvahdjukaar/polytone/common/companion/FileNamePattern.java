...
public sealed interface FileNamePattern {
    ...
    Set<Integer> presentIndexes(ScannedTextures textures, ResourceLocation contentId);
    ...
    record Suffix(String suffix) implements FileNamePattern {
        ...
        @Override
        public Set<Integer> presentIndexes(ScannedTextures textures, ResourceLocation contentId) {
