...
public class ParticleModifier implements ITargetProvider {
    ...
    public static final Codec<ParticleModifier> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ...
            StrOpt.of(ParticleContextExpression.CODEC, "color").forGetter(p -> Optional.ofNullable(p.colorGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "life").forGetter(p -> Optional.ofNullable(p.lifeGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "size").forGetter(p -> Optional.ofNullable(p.colorGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "red").forGetter(p -> Optional.ofNullable(p.colorGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "green").forGetter(p -> Optional.ofNullable(p.colorGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "blue").forGetter(p -> Optional.ofNullable(p.colorGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "alpha").forGetter(p -> Optional.ofNullable(p.colorGetter)),
            StrOpt.of(ParticleContextExpression.CODEC, "speed").forGetter(p -> Optional.ofNullable(p.speedGetter)),
